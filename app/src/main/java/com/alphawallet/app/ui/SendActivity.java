...
public class SendActivity extends BaseActivity implements AmountReadyCallback, StandardFunctionInterface, AddressReadyCallback, ActionSheetCallback
{
    ...
    private void validateEIP681Request(QRResult result, boolean overrideNetwork)
    {
        ...
        {
            case ADDRESS:
                addressInput.setAddress(correctAddress(result.getAddress()));
                break;
            ...
            case TRANSFER:
                ...
                else if (resultToken.isERC20())
                {
                    ...
                    addressInput.setAddress(correctAddress(result.functionToAddress));
                    sendText.setVisibility(View.VISIBLE);
            ...
            case FUNCTION_CALL:
                ...
                if (result.functionToAddress != null) addressInput.setAddress(correctAddress(result.functionToAddress));
                break;
    ...
    private String correctAddress(String address) {
        if (VelasUtils.isVelasNetwork(currentChain)) {
            //show vlx address
